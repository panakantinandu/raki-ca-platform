export default function GoogleButton({ label }) {
  ...
  return (
    <button
      type="button"
      onClick={handleClick}
      className="flex w-full items-center justify-center gap-3 rounded-md border border-ink-border bg-ink-raised px-5 py-2.5 font-sans text-sm font-medium text-parchment transition-colors hover:border-brass/40 hover:bg-ink-surface"
    >
